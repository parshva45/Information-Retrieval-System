...
with open("../../Encoded Data Structures (Bonus)/Encoded-QueryID_Top100Docs_Proximity_with_stopping.txt", 'rb') as f:
...
newpath = r'../Precision Recall Tables/Proximity (Stopping)/'
