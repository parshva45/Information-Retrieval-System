...
with open("../../Encoded Data Structures (Bonus)/Encoded-QueryID_Top100Docs_Proximity_no_stopping.txt", 'rb') as f:
...
newpath = r'../Precision Recall Tables/Proximity (No Stopping)/'
