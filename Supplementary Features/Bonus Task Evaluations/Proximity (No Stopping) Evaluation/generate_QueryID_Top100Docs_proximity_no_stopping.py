...
path = r'../../Encoded Data Structures (Bonus)/Encoded-Top100-Docs-Proximity-NoStopping'
queryID_top100Docs = {}
for file in os.listdir(path):
    doc_pScore = {}
    current_file = os.path.join(path,file)
    string = current_file.split("Encoded-Top100Docs-Proximity-NoStopping_")
    id = string[1].split(".")[0]
...
output = open('../../Encoded Data Structures (Bonus)/Encoded-QueryID_Top100Docs_Proximity_no_stopping.txt', 'wb')
