...
public class Lucene {
    ...
    public static void main(String[] args) throws IOException {
		...
		PrintWriter writer = new PrintWriter("Stemmed_Lucene_Top100_Pages.txt", "UTF-8");			
		PrintWriter writer1 = new PrintWriter("Stemmed_Lucene_Top5_Docs.txt", "UTF-8");
	    ...
	    try {
	    	String contents = new String(Files.readAllBytes(Paths.get("../cacm_stem.query.txt")));
	    	int k = 0;
	    	for(String str:contents.split("\r\n")){
	    		...
	    		if(str != "")
	    		{
	    			...
	    			for (int i = 0; i < hits.length; ++i) {
	    				...
	    				writer.println(k+" Q0 "+d.get("path").substring(pos,tot-4)+" "+(i+1)+" "+hits[i].score+" LuceneStemNoStop");
	    				if(i < 5)
