...
path = r'../../../Phase 1/Task 3/Part A/Encoded Data Structures (Stopped)/Encoded-Stopped_TF-IDF-Normalized-Top100Docs-perQuery'
queryID_top100Docs = {}                          # dictionary to store query id as key and it's corresponding
                                                 # top 100 documents as it's value
for file in os.listdir(path):
    doc_tf_idfScore = {}
    current_file = os.path.join(path,file)
    string = current_file.split("Encoded-Top100Docs-Stopped_TF-IDF-Normalized_")
...
output = open(newpath + 'Encoded-QueryID_Top100Docs_Stopped_tf-idf_normalized.txt', 'wb')
