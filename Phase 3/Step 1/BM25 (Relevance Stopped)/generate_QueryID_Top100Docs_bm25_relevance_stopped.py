...
path = r'../../../Phase 1/Task 3/Part A/Encoded Data Structures (Stopped)/Encoded-Stopped_BM25-Relevance-Top100Docs-perQuery'
...
for file in os.listdir(path):
    ...
    string = current_file.split("Encoded-Top100Docs-Stopped_BM25-Relevance_")
...
output = open(newpath + 'Encoded-QueryID_Top100Docs_Stopped_BM25_Relevance.txt', 'wb')
