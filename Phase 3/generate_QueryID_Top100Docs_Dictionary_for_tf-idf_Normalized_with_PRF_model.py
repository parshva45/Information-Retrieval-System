...
path = r'C:\Users\virat\PycharmProjects\Project\Implementation Phase 1\Task 2\Top_100_docs_using_tf-idf_normalized_for_prf_encoded'
queryID_top100Docs = {}
...
output = open('QueryID_Top100Docs_by_TF-IDF_Normalized_ForPRF_encoded.txt' , 'wb')
