...
with open("../../../Phase 1/Task 3/Part A/Encoded Data Structures (Stopped)/Encoded-Stopped_QueryID_RelevantDocs.txt", 'rb') as f:
    queryID_relevantDocs = pickle.loads(f.read())

with open("../../Encoded Data Structures (Phase 3)/Encoded-QueryID_Top100Docs_Stopped_Lucene.txt", 'rb') as f:
...
newpath = r'../../Precision Recall Tables/Lucene (Stopped)/'
if not os.path.exists(newpath):
    os.makedirs(newpath)

# function to calculate the total no. of relevant docs for a particular query
def calculate_total_no_of_relevant_docs(i):
    R = 0
