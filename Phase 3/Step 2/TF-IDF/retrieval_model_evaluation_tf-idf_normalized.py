...
with open("../../Encoded Data Structures (Phase 3)/Encoded-QueryID_Top100Docs_tf-idf_normalized.txt", 'rb') as f:
...
newpath = r'../../Precision Recall Tables/TF-IDF-Normalized Evaluation Results/'
