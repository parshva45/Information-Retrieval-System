...
with open("../../Encoded Data Structures (Phase 3)/Encoded-QueryID_Top100Docs_BM25_NoRelevance.txt", 'rb') as f:
...
newpath = r'../../Precision Recall Tables/BM25 Evaluation Results/BM25 (No Relevance)/'
