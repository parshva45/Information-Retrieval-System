...
with open("../../Encoded Data Structures (Phase 3)/Encoded-QueryID_Top100Docs_Stopped_BM25_Relevance.txt", 'rb') as f:
...
newpath = r'../../Precision Recall Tables/BM25 (Relevance Stopped)/'
