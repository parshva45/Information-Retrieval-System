...
path = r'C:\Users\virat\PycharmProjects\Project\Top_100_docs_using_ql_prf_encoded'
queryID_top100Docs = {}
for file in os.listdir(path):
    doc_qlmScore = {}
    current_file = os.path.join(path,file)
    string = current_file.split("Top_100_documents_using_qlm_prf_model_for_query_")
...
output = open('QueryID_Top100Docs_by_QLM_PRF_encoded.txt' , 'wb')
