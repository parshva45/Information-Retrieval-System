...
queryID_Top100Docs = {}
top_100_docs = []
with open("Top_100_docNames_for_queries_using_lucene_SA_PRF_model.txt", 'r', encoding = 'utf-8') as f:
   l = f.readlines()
...
output = open('QueryID_Top100Docs_by_lucene_SA_WithPRF_encoded.txt' , 'wb')
