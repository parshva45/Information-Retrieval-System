...
path = r'C:\Users\virat\PycharmProjects\Project\Bonus\Top_100_docs_using_proximity_encoded'
queryID_top100Docs = {}
for file in os.listdir(path):
    doc_pScore = {}
    current_file = os.path.join(path,file)
    string = current_file.split("Top_100_documents_using_proximity_for_query_")
...
output = open('QueryID_Top100Docs_by_proximity_encoded.txt' , 'wb')
