...
with open("QueryID_Top100Docs_by_QLM_PRF_encoded.txt", 'rb') as f:
...
for qID in queryID_relevantDocs:
    ...
    if docName_R_N == {}:
        continue
    f = open("Precision_Recall_Tables/QLM-PRF/Precision_Recall_Table_for_" +qID+'.txt', 'w')
...
f1 = open("Precision_Recall_Tables/QLM-PRF/Final Evaluation.txt", 'w')
...
f2 = open("Precision_Recall_Tables/QLM-PRF/P@KValuesForAllQueries.txt",'w')
for qID in queryID_relevantDocs:
