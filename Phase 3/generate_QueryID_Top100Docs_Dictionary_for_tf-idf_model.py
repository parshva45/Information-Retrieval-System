...
path = r'C:\Users\virat\PycharmProjects\Project\Top_100_docs_using_tf-idf_encoded'
queryID_top100Docs = {}
for file in os.listdir(path):
    doc_tf_idfScore = {}
    current_file = os.path.join(path,file)
    string = current_file.split("Top_100_documents_using_tf-idf_model_for_query_")
...
output = open('QueryID_Top100Docs_by_TF-IDF_encoded.txt' , 'wb')
