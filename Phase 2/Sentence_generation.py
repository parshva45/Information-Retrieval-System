...
path3 = os.path.dirname(os.path.realpath(__file__)) + "/../Phase 1/Task 3/Part A/Step 4/BM25 (Stopped)/Stopped_BM25_NoRelevance_Top5_Docs.txt"
...
f = open(r'Snippets_Stopped_BM25_NoRelevance.txt', 'w')
